...
def home():
    ...
    <head>
        ...
        <style>
            ...
            .logo { width: 120px; height: 120px; border-radius: 50%; background: white; padding: 5px; }
            .card { background: white; margin: 20px; padding: 20px; border-radius: 10px; }
            .btn { background: #1e3a8a; color: white; padding: 12px 25px; border-radius: 5px; text-decoration: none; display: inline-block; margin:10px; }
        </style>
    </head>
    <body>
        <div class="header">
